"""Render simulation requests as standalone native epydemix programs."""
...
def render_simulation_python(request: SimulationRequest) -> str:
    """Render a simulation request as a standalone native epydemix script.
    ...
    sections: list[str] = [
        "# Generated by the epydemix web API. This file uses native epydemix commands.",
        *imports,
    ]
    if needs_eigenvalue:

...
The simulator is fully stochastic and draws multinomial draws at each step with given rates. The expected dynamics matches the mean-field approximation as above.

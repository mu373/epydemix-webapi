...
We'll use the `SIR` preset. See [Model Presets](./model/presets.mdx) for the SIR / SEIR / SIS compartments and default parameters, or [Custom Models](./model/custom-models.mdx) to define your own compartments and transitions.

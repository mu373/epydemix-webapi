...
| [V-SEIR](./v-seir.mdx) | 8 (S/E/I/R × unvaccinated/vaccinated) | You want SEIR with a vaccinated branch and a vaccination rollout via [the `vaccination` block](../../vaccination/overview.mdx), without an explicit hospitalization compartment. |

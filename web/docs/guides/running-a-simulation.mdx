...
We'll use the `SIR` preset. See [Model Presets](./model/presets/overview.mdx) for the SIR / SEIR / SIS / V-SEIR / V-SEIHR compartments and default parameters, or [Custom Models](./model/custom-models.mdx) to define your own compartments and transitions.

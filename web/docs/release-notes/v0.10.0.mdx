...
equivalent to requests sent to the web API. The generated scripts call epydemix
directly, allowing users to inspect the Python code and run the corresponding
simulation or resource setup locally.
...
- Add the [Python export guide](/docs/guides/python-exports) with request examples and local execution instructions.

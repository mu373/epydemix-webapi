...
| [V-SEIHR](./v-seihr.mdx) | 10 (S/E/I/H/R × unvaccinated/vaccinated) | You want SEIR with explicit hospitalization, a vaccinated parallel layer, and a vaccination rollout via [the `vaccination` block](../../vaccination/overview.mdx). |

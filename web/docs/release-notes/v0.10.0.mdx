...
date: 2026-08-21
summary: |
  - Export API requests and resources as native Epydemix Python
  - Reproduce simulation results locally with the same random seed
---
...
- Add native Python exports for simulations, populations, contact matrices, and model presets.
- Generate standalone programs that depend on Epydemix rather than the WebAPI package.
- Preserve seeded simulation behavior so exported programs can reproduce API results locally.

...
See [Parameter Transforms › Seasonality](./guides/parameter-transforms.mdx#seasonality) for the math.
...
See [Model › Parameters](./guides/model/parameters.mdx#age-varying-parameters).
...
See [Parameter Transforms › Override](./guides/parameter-transforms.mdx#override).
...
See [Parameter Transforms › Inspecting the effective parameter values](./guides/parameter-transforms.mdx#inspecting-the-effective-parameter-values).
